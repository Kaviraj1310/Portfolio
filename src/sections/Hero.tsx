        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col space-y-6">
            ...
            >
              ...
              <a href="/Kaviraj%20Thangapandian%20Resume.pdf" target="_blank" rel="noreferrer" className="glass px-6 py-3 rounded-full flex items-center gap-2 text-white hover:bg-white/10 transition-all hover:scale-105 active:scale-95">
